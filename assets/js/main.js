const dictionary = {
  es: {
    ...
    bioOne: 'Gio Zamora es un periodista independiente, creador de contenido, activista y fundador de Gio Global LLC de 28 años. Se dedica a informar y apoyar a las comunidades latinas en Estados Unidos y México a través de reportajes de investigación rigurosos y contenido digital de alto impacto.',
    bioTwo: 'Desde que inició su trabajo en el periodismo en 2022, Gio se ha enfocado en cubrir temas clave en la intersección de la seguridad, la inmigración y la política binacional entre México y Estados Unidos. Su trabajo combina investigación profunda con un estilo de comunicación claro y directo, guiado por la verdad, la imparcialidad y la objetividad.',
